...
#ifndef _EDGE_DRAWING_H
#define _EDGE_DRAWING_H

#include "region.h"
#include "scalar_sched.h"

//void init_jsr_operands (void);

void add_merge_to_control_merge(Op* old_mg, Op* new_mg);
void add_switch_to_control_switch(Op* old_sw, Op* new_sw);

void insert_region_scalar_edges (Compound_region* r, El_Scalar_Sched_Phase phase = EL_SCALAR_SCHED_UNKNOWN);
