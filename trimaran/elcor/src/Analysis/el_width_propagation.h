...
#ifndef EL_WIDTH_PROPAGATION_H
#define EL_WIDTH_PROPAGATION_H
...
void compute_width_propagation_down(
        WConstraint* orig_constraint,
        WConstraint* max_constraint,
        int destnum,
        Opcode opc,
        WConstraint srcconstraints[],  
        int num_constraints,
        int debug_flag, 
 	int local_differ );
