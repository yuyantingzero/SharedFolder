...
Liveness_info_attrib::Liveness_info_attrib() : info(0) {}

Liveness_info_attrib::~Liveness_info_attrib()
{
  delete info ;
}

Base_attribute* Liveness_info_attrib::clone_attribute()
{
  Liveness_info_attrib* tmp_ptr = new Liveness_info_attrib() ;
  tmp_ptr->info = new Liveness_info(*info) ;
  return(tmp_ptr) ;
}
...
Downward_use_attrib::Downward_use_attrib() : info(0) {}

Downward_use_attrib::~Downward_use_attrib()
{
  delete info ;
}

Base_attribute* Downward_use_attrib::clone_attribute()
{
  Downward_use_attrib* tmp_ptr = new Downward_use_attrib() ;
  tmp_ptr->info = new Liveness_info(*info) ;
  return(tmp_ptr) ;
}

Liveness_info* get_down_exposed_uses_info(Edge* edge) {
   Downward_use_attrib* tmp_ptr ;

   tmp_ptr = (Downward_use_attrib*) (edge->attributes->get_attribute(DOWN_EXPOSED_USES_SET));
   if (tmp_ptr == NULL) {
      return (NULL) ;
   }
   return (tmp_ptr->info) ;
...
void set_down_exposed_uses_info(Edge* edge, Liveness_info* li) {
  ...
  tmp_ptr = (Downward_use_attrib*) (edge->attributes->get_attribute(DOWN_EXPOSED_USES_SET));
  if (tmp_ptr == NULL) {
    tmp_ptr = new Downward_use_attrib ;
    tmp_ptr->info = NULL ;
...
Upward_def_attrib::Upward_def_attrib() : info(0) {}

Upward_def_attrib::~Upward_def_attrib()
{
  delete info ;
}

Base_attribute* Upward_def_attrib::clone_attribute()
{
  Upward_def_attrib* tmp_ptr = new Upward_def_attrib() ;
  tmp_ptr->info = new Liveness_info(*info) ;
  return(tmp_ptr) ;
}

Liveness_info* get_up_exposed_defs_info(Edge* edge) {
  Upward_def_attrib* tmp_ptr ;

  tmp_ptr = (Upward_def_attrib*) (edge->attributes->get_attribute(UP_EXPOSED_DEFS_SET));
  if (tmp_ptr == NULL) {
    return (NULL) ;
  }
  return (tmp_ptr->info) ;
...
Downward_def_attrib::Downward_def_attrib() : info(0) {}

Downward_def_attrib::~Downward_def_attrib()
{
  delete info ;
}

Base_attribute* Downward_def_attrib::clone_attribute()
{
  Downward_def_attrib* tmp_ptr = new Downward_def_attrib() ;
  tmp_ptr->info = new Liveness_info(*info) ;
  return(tmp_ptr) ;
}

Liveness_info* get_down_exposed_defs_info(Edge* edge) {
  Downward_def_attrib* tmp_ptr ;

  tmp_ptr = (Downward_def_attrib*) (edge->attributes->get_attribute(DOWN_EXPOSED_DEFS_SET));
  if (tmp_ptr == NULL) {
    return (NULL) ;
  }
  return (tmp_ptr->info) ;
...
void set_down_exposed_defs_info(Edge* edge, Liveness_info* li) {
  ...
  tmp_ptr = (Downward_def_attrib*) (edge->attributes->get_attribute(DOWN_EXPOSED_DEFS_SET));
  if (tmp_ptr == NULL) {
    tmp_ptr = new Downward_def_attrib ;
    tmp_ptr->info = NULL ;
...
Control_flow_freq::Control_flow_freq() : freq(0), cc(EL_UNKNOWN_CC_VAL) {}

Control_flow_freq::~Control_flow_freq() {}

Base_attribute* Control_flow_freq::clone_attribute()
{
  Control_flow_freq* tmp_ptr = new Control_flow_freq() ;
  return(tmp_ptr) ;
}
