...
//
//      File:           attributes.h
//      Authors:        Sadun Anik, Richard Johnson, Dave Agust,
//                      Vinod Kathail, Brian Deitrich
...
class Graph_attribute {
   public:
      ...
      Graph_attribute& operator=(Graph_attribute&) ;
	
      void insert_attribute(Attribute_type, Base_attribute*) ;
      Base_attribute* get_attribute(Attribute_type) ;
      void remove_attribute(Attribute_type) ;

      void IR_print_inline(IR_outstream &out) ;
      void IR_print_offline(IR_outstream &out) ;

      void IR_parse_inline(IR_instream &in) ;
      void IR_parse_offline(IR_instream &in) ;

      void IR_name_attributes(IR_outstream &out) ;
   private:
//   void delete_attribute(Attribute_type, Base_attribute*) ;
//   Base_attribute* clone_attribute(Attribute_type, Base_attribute*) ;
      Map<Attribute_type, Base_attribute*> attribute_map ;
} ;
...
// Generic attributes
// 
typedef Map<eString,void*> Generic_attribute_map ;

class Generic_attribute_map_attrib : public Base_attribute {
public:
  Generic_attribute_map_attrib() ;
  ~Generic_attribute_map_attrib() ;
      
  Base_attribute* clone_attribute() ;
  bool has_rebel_io() { return false; }
  Attribute_type attribute_type() { return GENERIC_ATTRIBUTES; }
  ...
  Generic_attribute_map* map ;
} ;

//////////////////////////////////////////////////////////////
// Generic edge attribute access functions
//////////////////////////////////////////////////////////////
//
...
//
// YOU SHOULD NOT NEED TO USE THE NEXT THREE FUNCTIONS USE THE
// THREE FUNCTIONS ABOVE
//
// Base generic attribute functions
//
...
//////////////////////////////////////////////////////////////
// Generic region attribute access functions
//////////////////////////////////////////////////////////////
//
