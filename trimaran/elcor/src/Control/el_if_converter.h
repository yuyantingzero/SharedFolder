...
#ifndef EL_IF_CONVERTER_H
#define EL_IF_CONVERTER_H

#include "control_analysis_solver.h"

void El_if_convert(Compound_region*, bool);


class El_If_Converter {
public:
  El_If_Converter();
  El_If_Converter(Compound_region*);
  ~El_If_Converter();

  Hyperblock* if_convert(Hash_set<Compound_region*> blocks,
...
void El_fix_hb_bottom(Hyperblock* new_hyperblock,Basicblock* last_bb,bool fully_resolved_predicates,
		  Map< Basicblock*, Operand > bb_pred_map, Dlist<Basicblock*> bb_order,Hash_set<Basicblock*> bb_blocks);
...
void el_topo_sort_bbs(Dlist<Basicblock*>& bb_order, List_set<Basicblock*>& bb_blocks,
		      Basicblock* entry_bb);
...
void El_create_hb( Hyperblock* new_hyperblock,Dlist<Basicblock*>& bb_order,
		   Basicblock*& lst_bb,Basicblock* entry_bb,
		   Map< Edge*, Hash_set<Operand> >& edge_pred_map);
...
void El_connect_non_hb_exit_edge(Basicblock* last_bb,Basicblock* cur_bb,bool exit_true,int final_num_edges);
