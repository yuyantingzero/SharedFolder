...
#ifndef _MOD_PRE_POST_
#define _MOD_PRE_POST_
...
// ----------------------- Post processing of pre and post loop -----------
//   1. Inserts ops to set esc in preloop.
//   2. Clear all rotating registers in preloop. (Up for debate)
//   3. Set staging predicate in preloop. 
//   4. Insert copies from vrs to rotating regsiters for live-ins 
//       in the preloop
//   5. Insert copies from rotating registers to vrs for live-outs in
//      post-loop
