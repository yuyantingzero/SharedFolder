...
#ifndef _MELD_PROPAGATE_
#define _MELD_PROPAGATE_

#include "region.h"
#include "hash_map.h"
#include "meld.h"

#define SUPERSCALAR_MELD 0

extern Hash_map<Edge*, bool>* cfEdgeIsPredicted;
...
void propagate_to_entry_lat_maps (Compound_region* region_sched,
	       Map<Pair<Compound_region*, Op*>, Pair<int, bool> >& dist_map,
	       Latency_map* import_def_map, Latency_map* import_use_map);

void set_merge_list (Compound_region* region_sched,
		Latency_map* import_def_map, Latency_map* import_use_map);

void min_dist_from_exit (Compound_region* region_sched, Op* exit_op_sched,
	   int cutoff_dist, Map<Pair<Compound_region*, Op*>, int >& dist_map);
