...
template Hash_set<Basicblock *>;
template Hash_set_iterator<Basicblock *>;

// template class Hash_set<Hsi >;
...
// template Sumedh: for Tree Formation algo
// template class List<Flat_tree *>;
// template class List_iterator<Flat_tree *>;
