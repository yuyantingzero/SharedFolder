...
// Data structure xlation templates

template class Hash_table_iterator<void*>;

template class Hash_map<L_Oper*,Op* >;
template class Map<L_Cb*,Region* >;
template class Map_iterator<int,int>;
template class Stuple<int,int>;
template class Slist_iterator<Stuple<int,int> >;


// Required for el_mem_prof_to_sync_vars.cpp
template class Vector<Memref_type > ;
